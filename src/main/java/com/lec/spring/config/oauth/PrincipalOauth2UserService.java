...
public class PrincipalOauth2UserService extends DefaultOAuth2UserService {
    ...
    @Autowired
    private UserService userService;  // 회원조회,가입 시키기위해 주입
    ...
    // ★ loadUser() 라 리턴하는 OAuth2User 가 Authentication 안에 들어간다!
    @Override
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {

        OAuth2User oAuth2User = super.loadUser(userRequest);  // 사용자 프로필정보 가져오기
